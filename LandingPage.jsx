...
function OfferingsSection() {
  ...
  return (
    <section className="lp-offerings" aria-labelledby="lp-offerings-h">
      <div className="container">
        <div className="lp-section-head">
          <div className="divider">
            <div className="divider-line"></div>
          ...
          <h2 className="display-lg" id="lp-offerings-h">
        ...
        <div className="lp-offer-feature">
          <div className="lp-offer-feature-photo">
            <img src={offerings[active].img} alt={offerings[active].title} loading="lazy"/>
            <span className="lp-offer-feature-num">{offerings[active].n}</span>
          </div>
          <h3 className="display-md lp-offer-feature-title">{offerings[active].title}</h3>
          <p className="lp-offer-feature-desc">{offerings[active].desc}</p>
        </div>

        <ul className="lp-offer-list" role="tablist">
          {offerings.map((o, i) => (
            <li
              key={i}
              className={`lp-offer-row ${i === active ? 'is-active' : ''}`}
              onClick={() => setActive(i)}
              role="tab"
            ...
            >
              <span className="lp-offer-row-n">{o.n}</span>
              <span className="lp-offer-row-title">{o.title}</span>
              <span className="lp-offer-row-arrow"><IconArrow width="14" height="14"/></span>
            </li>
          ))}
        </ul>
      </div>
